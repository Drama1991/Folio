...
function AccountPanel({
  ...
  return (
    <>
      ...
      {/* 登录身份卡 */}
      <div className="setting-card" style={{ border: "0.5px solid var(--border)", borderRadius: "var(--r)", overflow: "hidden", marginBottom: 18 }}>
        <SettingRow
          k="登录身份"
      ...
      <p
        ...
        style={{ textTransform: "uppercase", color: "#A03B3B", marginBottom: 6 }}
      >
        ⚠ 登出
      </p>
      <div
...
function AppearancePanel() {
  ...
  return (
    <>
      ...
      {/* 信息密度 */}
      <SubLabel style={{ marginTop: 22 }}>信息密度</SubLabel>
      <Segmented<Density>
      ...
      {/* 动效 */}
      <SubLabel style={{ marginTop: 22 }}>动效</SubLabel>
...
function SubLabel({ children, style }: { children: React.ReactNode; style?: React.CSSProperties }) {
  return (
    <p
      className="section-label"
      style={{ textTransform: "uppercase", marginBottom: 8, ...style }}
    >
      {children}
    </p>
  );
...
function DataPanel() {
  ...
  return (
    <>
      ...
      {/* 状态行 */}
      {(status || err) && (
        <div style={{ marginBottom: 12, fontSize: 12, fontFamily: "var(--mono)" }}>
      ...
      {/* 占位：豆瓣导入 / NeoDB 重建 */}
      <div className="setting-card" style={{ border: "0.5px solid var(--border)", borderRadius: "var(--r)", overflow: "hidden", marginBottom: 10 }}>
        <div style={{ padding: "14px 18px", display: "flex", alignItems: "center", gap: 14, borderBottom: "0.5px solid var(--border)" }}>
          <div style={{ flex: 1 }}>
      ...
      {/* 本地缓存 */}
      <div style={{ border: "0.5px solid var(--border)", borderRadius: "var(--r)", overflow: "hidden", marginBottom: 18 }}>
        <div style={{ padding: "14px 18px", display: "flex", alignItems: "center", gap: 14 }}>
          <div style={{ flex: 1 }}>
...
function AboutPanel({ version, buildDate }: { version: string; buildDate: string }) {
  ...
  return (
    <>
      ...
      {/* 技术信息行（替代原型里的「数据来源」） */}
      <div className="setting-card" style={{ border: "0.5px solid var(--border)", borderRadius: "var(--r)", overflow: "hidden", marginBottom: 14 }}>
